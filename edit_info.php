...
<div class="row">
   <div class="col-md-8 col-md-push-3" id="newhead">
    <h4>Insert New Bus</h4>
	<form role="form" method="post" action="insert_newcheck.php">
    <div class="form-group">
    <label for="exampleInputText">Bus Number :</label>
    <input type="text" class="form-control" id="exampleInputText1" placeholder="D/W 05342" name="busnumber">
    </div>
    <div class="form-group">
	...
	<div class="form-group">
    <label for="exampleInputDate1">IMEI Number :</label>
    <input type="text" class="form-control" id="exampleInputText1" placeholder="IMEI Number of the Driver's Device" name="imeiNumber">
    </div>
	<input type="submit" value="Update" class="btn btn-success" style="margin-left:30%;width:20%">
	</form>
